...
- [Maven](https://s01.oss.sonatype.org/content/repositories/snapshots/com/github/kepocnhh/Logics/0.1.0-SNAPSHOT)
- [Documentation](https://StanleyProjects.github.io/Logics/doc/0.1.0-SNAPSHOT)
...
dependencies {
    implementation("com.github.kepocnhh:Logics:0.1.0-SNAPSHOT")
}
```
